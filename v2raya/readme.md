...
2. На внешнем накопителе в папке `System` создать подпапку `v2raya` (тут будут храниться все необходимое для adguard home) и пару системных папок:
...
Через команды `service v2ray help` и `service v2raya help` (и подобные команды)
